...
- [x] 5.1 Implement workflow event hooks and recipient resolution for assignments, reviews, join approvals, merge outcomes, dependency unlocks, and downstream cascade-resets. Include task-reassignment notifications sent to the previous assignee.
